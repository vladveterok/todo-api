RSpec.describe 'Users signup API', type: :request do
  include Docs::Signup::Api

  describe 'POST #create' do
    include Docs::Signup::Create
    ...
    context 'when password is invalid' do
      ...
      it 'returns invalid password error', :dox do
    ...
    context 'when passwod_confirmation is invalid' do
      ...
      it 'returns invalid password_confirmation error', :dox do
    ...
    context 'when email is wrong' do
      ...
      it 'returns wrong email format error', :dox do
        expect(json['errors']).to include(error)
      end
    end
    ...
    context 'when email is registered' do
      ...
      it 'returns email taken error', :dox do
        expect(json['errors']).to include(error)
      end
    end
  end
